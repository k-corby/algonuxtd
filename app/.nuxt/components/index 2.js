...
export { default as Logo3 } from '../../components/section/logo/Logo3.vue'
...
export const LazyLogo3 = import('../../components/section/logo/Logo3.vue' /* webpackChunkName: "components/logo3" */).then(c => wrapFunctional(c.default || c))
...
export const LazyIconLink = import('../../components/IconLink.vue' /* webpackChunkName: "components/icon-link" */).then(c => wrapFunctional(c.default || c))
