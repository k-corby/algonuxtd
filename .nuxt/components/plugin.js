...
const components = {
  LoadingBar: () => import('../../components/ui/LoadingBar.vue' /* webpackChunkName: "components/loading-bar" */).then(c => wrapFunctional(c.default || c)),
  ...
  NavButton: () => import('../../components/ui/NavButton.vue' /* webpackChunkName: "components/nav-button" */).then(c => wrapFunctional(c.default || c)),
  ...
  AppFooter: () => import('../../components/section/AppFooter.vue' /* webpackChunkName: "components/app-footer" */).then(c => wrapFunctional(c.default || c)),
