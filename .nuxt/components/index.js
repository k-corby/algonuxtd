...
export const LazyButton = import('../../components/ui/Button.vue' /* webpackChunkName: "components/button" */).then(c => wrapFunctional(c.default || c))
export const LazyDownArrow = import('../../components/ui/DownArrow.vue' /* webpackChunkName: "components/down-arrow" */).then(c => wrapFunctional(c.default || c))
...
export const LazyAppMenuItems = import('../../components/AppMenuItems.vue' /* webpackChunkName: "components/app-menu-items" */).then(c => wrapFunctional(c.default || c))
export const LazyAppNavigation = import('../../components/AppNavigation.vue' /* webpackChunkName: "components/app-navigation" */).then(c => wrapFunctional(c.default || c))
